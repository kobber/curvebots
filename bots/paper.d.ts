...
declare module 'paper' {
  ...
  */
   ...
   */
  export function setup(canvas: [number, number]): void;
  ...
  export class PaperScope {
    ...
    */
     ...
     */
    setup(canvas: [number, number]): void;
  ...
  export class Item {
     ...
     */
    importSVG(string, options?: any): Item;
  ...
  export class Project {
     ...
     * @param options.selected - only hit selected items.
     */
    hitTestAll(point: Point, options?: { tolerance?: number; match?: (hitResult: HitResult)=>boolean; class?: string; fill?: boolean; stroke?: boolean; segments?: boolean; curves?: boolean; handles?: boolean; ends?: boolean; bounds?: boolean; center?: boolean; guides?: boolean; selected?: boolean; }): HitResult[];
  ...
  export class MouseEvent extends Event {
    constructor(type: string, event: any, point: Point, target: Item, delta: Point)
